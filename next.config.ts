...
const nextConfig: NextConfig = {
  ...
  // Next.js 16 usa Turbopack di default per i build
  // Turbopack gestisce automaticamente code splitting e ottimizzazioni
  // Non è necessaria configurazione webpack personalizzata
