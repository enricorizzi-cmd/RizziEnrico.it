...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
  ...
  <div style="background: #ffffff; padding: 30px; border-radius: 0 0 10px 10px;">
    ...
    <p style="font-size: 18px; margin-bottom: 20px;">Oggi è il giorno! Ti aspettiamo al workshop <strong>"AI EXPERIENCE"</strong> <strong>dalle ore 17.00</strong> (accettazione dalle ore 16.30).</p>
    ...
    <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #667eea;">
      ...
      <p style="margin: 5px 0;"><strong>Indirizzo:</strong> Rotonda Romea, 1 - Venezia</p>
    ...
    <div style="background: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 4px;">
      <p style="margin: 0;"><strong>💡 Ultimo reminder:</strong> Se non l'hai ancora fatto, compila il <a href="${BASE_URL}/test-maturita-digitale" style="color: #667eea; font-weight: bold;">Test Digitalizzazione Aziendale</a> per personalizzare l'esperienza.</p>
    </div>
...
Ti aspettiamo al workshop "AI EXPERIENCE" dalle ore 17.00 (accettazione dalle ore 16.30).
